...
class OptimizationIntelligenceEngine:
    ...
    def _flow_w(self, flows: dict[str, Any], *keys: str) -> float | None:
        ...
        Thin wrapper over the shared canonical accessor so this engine and the
        rest of Zeus resolve the same field names and aliases.
        """
        for key in keys:
    ...
    def refresh(self) -> dict[str, Any]:
        ...
        # integrated into invented kWh actuals. Surplus is read from the one
        # canonical signed grid balance instead of being re-derived here.
        live_surplus_w = None
